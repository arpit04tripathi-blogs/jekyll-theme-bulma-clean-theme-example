...
7. Replace all instances of text `jekyll-theme-bulma-clean-theme-example` with your repo name (example - `my_repo_name`), this will change below files
   1. `docker-compose.yml` - change `container_name: jekyll-theme-bulma-clean-theme-example` to `container_name: my_repo_name`
   2. `localhost.sh` - `http://localhost:9999/jekyll-theme-bulma-clean-theme-example/` to `http://localhost:9999/my_repo_name/`
8. `_config.yml`
